...
extension ForcingFunctionWidgetAttributes {
    fileprivate static var preview: ForcingFunctionWidgetAttributes {
        ForcingFunctionWidgetAttributes(name: "World")
    }
}

extension ForcingFunctionWidgetAttributes.ContentState {
    fileprivate static var smiley: ForcingFunctionWidgetAttributes.ContentState {
        ForcingFunctionWidgetAttributes.ContentState(emoji: "😀")
     }
     
     fileprivate static var starEyes: ForcingFunctionWidgetAttributes.ContentState {
         ForcingFunctionWidgetAttributes.ContentState(emoji: "🤩")
     }
}
...
#Preview("Notification", as: .content, using: ForcingFunctionWidgetAttributes.preview) {
   ForcingFunctionWidgetLiveActivity()
    ...
    ForcingFunctionWidgetAttributes.ContentState.smiley
    ForcingFunctionWidgetAttributes.ContentState.starEyes
}
